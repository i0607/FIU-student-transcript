    ...
    [
        ...
        'version' => 'Old'
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => DB::table('courses')->where('code', 'GEED01')->value('id'),
                'course_category' => 'UE',
                'title' => 'GENERAL EDUCATION ELECTIVE-I',
                'lecture_hours' => 3,
                'lab_hours' => 0,
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => DB::table('courses')->where('code', 'GEED02')->value('id'),
                'course_category' => 'UE',
                'title' => 'GENERAL EDUCATION ELECTIVE-II',
                'lecture_hours' => 3,
                'lab_hours' => 0,
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => DB::table('courses')->where('code', 'HIST100')->value('id'), // or TURK100
                'course_category' => 'UC',
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => null, // TE-01 - Technical Elective
                'course_category' => 'AE',
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => null, // TE-02 - Technical Elective
                'course_category' => 'AE',
                'title' => 'TECHNICAL ELECTIVE',
                'lecture_hours' => 3,
                'lab_hours' => 0,
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => DB::table('courses')->where('code', 'GEED03')->value('id'),
                'course_category' => 'UE',
                'title' => 'GENERAL EDUCATION ELECTIVE-III',
                'lecture_hours' => 3,
                'lab_hours' => 0,
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => null, // TE-03 - Technical Elective
                'course_category' => 'AE',
                'title' => 'TECHNICAL ELECTIVE',
                'lecture_hours' => 3,
                'lab_hours' => 0,
            ...
            [
                'faculty_id' => $engineeringFacultyId,
                'department_id' => $computerEngDeptId,
                'course_id' => null, // TE-04 - Technical Elective
                'course_category' => 'AE',
                'title' => 'TECHNICAL ELECTIVE',
                'lecture_hours' => 3,
                'lab_hours' => 0,
